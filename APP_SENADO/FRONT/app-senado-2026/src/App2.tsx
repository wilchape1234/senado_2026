            ...
            <ul className="navbar-nav align-items-center gap-3">
              {visibleItems.map((item) => (
                <li className="nav-item" key={item.path}>
                  <Link to={item.path} className="nav-link text-white fw-medium hover-underline">
                    {item.name}
                  </Link>
                </li>
              ))}
              ...
              {user ? (
                <div className="dropdown">
                  ...
                  >
                    ...
                    <span className="badge bg-light text-primary rounded-pill ms-1">R{user.rolId}</span>
                  </button>
          ...
          {user ? (
            <div className="alert alert-primary d-flex align-items-center gap-3 mb-4">
               ...
               <div className="overflow-hidden">
                 ...
                 <div className="small text-muted">Rol ID: {user.rolId}</div>
               </div>
            </div>
          ) : (
